...
[![x-cmd/install — pixi Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/pixi.svg?lang=zh)](https://x-cmd.com/install/pixi)
...
合计: **279,663** 行代码（覆盖前 5 种语言、共 **1508** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Rust | 206,045 | 10,341 | 25,912 | 663 |
| Json | 29,679 | 0 | 0 | 89 |
...
- **上游仓库**: <https://github.com/prefix-dev/pixi>
- **官网**: <https://pixi.sh>
- **许可证**: BSD-3-Clause
...
- **Star**: 7,776 · **Fork**: 565 · **开放 issue**: 2,699 · **贡献者**: 294

## 累计统计

- **发布数**: 148 · **已合并 PR**: 3327 · **开放 PR**: 160 · **已关闭 issue**: 2130 · **开放 issue**: 569 · **提交数**: 3644

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-27 | 4 | 61 | 61 | 8 | 34 | 64 |
| last60d | 2026-07-28 | 10 | 174 | 79 | 29 | 60 | 186 |
| 90d | 2026-06-28 | 17 | 286 | 100 | 80 | 101 | 306 |
| last180d | 2026-03-30 | 28 | 668 | 117 | 217 | 151 | 681 |
| 360d | 2025-10-01 | 43 | 1139 | 147 | 499 | 259 | 1140 |
| last720d | 2024-10-06 | 94 | 2279 | 159 | 1297 | 474 | 2261 |
...
pixi 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `pixi` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/pixi.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260926.yml` · 2026-09-26T05:25:08Z._
